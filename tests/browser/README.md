...
| `dogg_heist.cjs` | Tick Tock DOGG Heist as a production-origin black box: four autonomous partial POVs, exact stepping and wall-clock pause/play under throttling, seeded replay, verifiable and corruption-sensitive history, scrub/fork, fresh-context export/import, visible controls and keyboard help, mobile reachability, and storage-denied degradation |
